...
import ForgetPasswordDoctorForm from "../../components/auth/doctor/forget-password-form";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {t("register_form.reset_form.title")}
        </Typography>
        ...
        <AnimatedTitle
          ...
          text={t("register_form.reset_form.description")}
        />
      </Box>

      <Box sx={{ width: "100%" }}>
        <ForgetPasswordDoctorForm />
