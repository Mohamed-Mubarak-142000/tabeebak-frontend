...
export interface CustomShadows {
  ...
  // New Salesforce-style shadows (Figma)
  sds100?: string; // Original black-100
  sds200?: string; // Original black-200
...
function createCustomShadows(colorChannel: string): CustomShadows {
  return {
    ...
    // New Salesforce-style shadows (Figma)
    sds100: `0 1px 3px -1px ${varAlpha(colorChannel, 0.1)}`,
    sds200: `0 4px 4px -1px ${varAlpha(colorChannel, 0.2)}`,
